...
CREATE TABLE "new_Grant" (
    ...
    "vestingType" TEXT NOT NULL DEFAULT 'STANDARD_FOUR_YEAR_ONE_YEAR_CLIFF',
    "totalVestingDurationMonths" INTEGER,
    "vestingInstallments" INTEGER,
...
INSERT INTO "new_Grant" ("agreementNo", "cliffMonths", "cliffPercent", "createdAt", "employeeId", "grantDate", "id", "lockupPeriodMonths", "strikePrice", "totalShares", "updatedAt", "vestingYears") SELECT "agreementNo", "cliffMonths", "cliffPercent", "createdAt", "employeeId", "grantDate", "id", "lockupPeriodMonths", "strikePrice", "totalShares", "updatedAt", "vestingYears" FROM "Grant";
DROP TABLE "Grant";
