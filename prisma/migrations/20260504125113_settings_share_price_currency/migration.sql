...
INSERT INTO "new_GlobalSettings" ("companySharePrice", "createdAt", "departmentsCsv", "id", "sharePriceTicker", "terminationOptionExpiryDays", "totalOptionPoolShares", "updatedAt") SELECT "companySharePrice", "createdAt", "departmentsCsv", "id", "sharePriceTicker", "terminationOptionExpiryDays", "totalOptionPoolShares", "updatedAt" FROM "GlobalSettings";
